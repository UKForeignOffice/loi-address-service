node {
    ...
    stage 'Step 2: Deploy to Integration'
        build job: 'Service Deployment/Deploy to Integration', parameters: [[$class: 'StringParameterValue', name: 'Repo', value: 'git@github-project-address:UKForeignOffice/loi-address-service.git'], [$class: 'StringParameterValue', name: 'Branch', value: 'Pre-Production'], [$class: 'StringParameterValue', name: 'Tag', value: 'address-service-preprod'], [$class: 'StringParameterValue', name: 'Container', value: 'address-service']]
}
